...
from fsdet.structures.anno import VocInstance
from fs.data.vocanno import VocAnnotation
...
def rotate_instances(annotations: "list[VocAnnotation]", step=1, img_dir="JPEGImages") -> "list[VocAnnotation]":
    """ 
    旋转图片，以及 bouding box
    img_dir: full path
    ...
    for anno in annotations[ran]:
        ...
        for angle in [ 90, 180, 270]:
            ...
            nva = VocAnnotation(**nanno)
            nva.set_annotations(instances)
            new_annos.append(nva)
    return new_annos
